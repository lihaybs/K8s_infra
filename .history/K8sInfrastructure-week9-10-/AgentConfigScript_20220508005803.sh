...
if [ -x "$(command -v systemctl)" ]; then
    ./config.sh --pool BuildPool --acceptteeeula --agent $HOSTNAME --url https://dev.azure.com/oderafiBigspender/ --work _work --projectname 'BOOTCAMP-APP K8S' --auth PAT --token i2jhj7k4paij3jmxaccu2jcyovozisnn6ucb5hz2q755vrgksyna --runasservice
    sudo ./svc.sh install
    sudo ./svc.sh start
else
    ./config.sh --pool BuildPool --acceptteeeula --agent $HOSTNAME --url https://dev.azure.com/oderafiBigspender/ --work _work --projectname 'BOOTCAMP-APP K8S' --auth PAT --token i2jhj7k4paij3jmxaccu2jcyovozisnn6ucb5hz2q755vrgksyna
    ./run.sh
fi
